...
public class MATaxComputation extends TaxComputation {
    ...
    public boolean taxHoliday(Date receiptDate) {
        ...
        Date taxHolidayStartdate = new  GregorianCalendar(receiptYear, Calendar.AUGUST, 13).getTime();
        Date taxHolidayEnddate = new  GregorianCalendar(receiptYear, Calendar.AUGUST, 14).getTime();
